...
<nav class="bg-white border-gray-200 dark:bg-gray-900 " id="navbar">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <img style="height:2.5rem" src="https://media.tenor.com/2sHsTvXPB3QAAAAC/book.gif" alt="" srcset="">    
        <span id="title" class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white" style="font-family: Roboto;">BookTalks</span>
        ...
        <div class="flex items-center md:order-2">
            ...
            <?php if ( isset($_SESSION["login"]) && $_SESSION["login"] == true) : ?>
                    ...
                    <svg class="w-8 h-8 rounded-full " fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path stroke-linecap="round" style="color:#fefefe" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"></path>
            ...
            <?php else :?>
                ...
                <a class="btn " role="button" href="/signup">S'inscrire</a>
                <a href="/login"  id="loginbtn" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Se connecter</a>
            <?php endif; ?>
                <!-- Dropdown menu -->
